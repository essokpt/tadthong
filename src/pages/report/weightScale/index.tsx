...
import { getWeightScaleReport } from '@/services/reportApi'
import {
  Command,
  CommandEmpty,
  CommandGroup,
...
export default function WeightScaleReports() {
  ...
  const getData = (fromDate: string, toDate: string, productId:number) => {
    console.log('getWeightScaleReport:', fromDate, toDate, productId)

    getWeightScaleReport(fromDate, toDate, productId).then((data) => {
      console.log('getWeightScaleReport:', data)
      setData(data)
      setRefresh(false)
